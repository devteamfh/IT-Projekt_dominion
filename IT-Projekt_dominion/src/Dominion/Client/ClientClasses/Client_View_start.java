...
public class Client_View_start extends View<Client_Model> {
	...
	protected Scene create_GUI() { 
			...
			//Buttons: Abst�nde festlegen und in gp einf�gen    
	...
	// F�r Drag und Drop verschiebung: relative x und y Position herausfinden
