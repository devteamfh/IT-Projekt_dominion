...
public class Cards {
	...
	ActionCard basement  	  = new ActionCard(new Label("basement"),2,1,0,0,"Keller");
	...
	ActionCard  chapel 	      = new ActionCard(new Label("chapel"),2,0,0,0,"Kapelle");
	...
	ActionCard forge		  = new ActionCard(new Label("forge"),4,0,0,0, "Schmiede"); // +3 karten
	ActionCard funfair		  = new ActionCard(new Label("funfair"),5,2,1,2, "Jahrmarkt");
	...
	ActionCard lumberjack 	  = new ActionCard(new Label("lumberjack"),3,0,1,2, "Holzf�ller");
	...
	ActionCard moat			  = new ActionCard(new Label("moat"),2,0,0,0, "Burggraben"); //+2 Karten angriff abwehren
	ActionCard moneylender	  = new ActionCard(new Label("moneylender"),4,0,0,0, "Geldverleiher"); //ewnn kupfer entwoftg wird +3
	ActionCard rebuilding	  = new ActionCard(new Label("rebuilding"),4,0,0,0, "Umbau"); //entsorgen und eine nehmen die bis zu 2 mehr kostet
	...
	ActionCard village		  = new ActionCard(new Label("village"),3,2,0,0, "Dorf"); //+1 karte
	//ActionCard waste        = new ActionCard(new Label("waste"),6,0,0,0);
	ActionCard witch 		  = new ActionCard(new Label("witch"),5,0,0,0, "Hexe"); //+2 karten, jeder eine fluchkarte
	ActionCard workshop 	  = new ActionCard(new Label("workshop"),3,0,0,0, "Werkstatt"); //+1 karte die bis zu vier mehr kostet
