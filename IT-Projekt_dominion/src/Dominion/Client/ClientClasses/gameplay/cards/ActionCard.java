				...
				@Override public void handle(MouseEvent e) {
					...
					if(isHoleCard() == false && croupier.isBuyMode() == true && costs <= croupier.getBuyPower() && croupier.getBuys() > 0 && croupier.getStackSize(ac)>0){
						...
						if(croupier.getBuys()==0){
			        		...
			        		history = new GameHistory(strBuilderForTextArea.toString(), null,sl.getCurrentGameParty(),sl.getPlayer_noOS(),ac.getLbl_cardName().getText(), GameHistory.HistoryType.EndBuy);
